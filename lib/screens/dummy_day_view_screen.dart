...
class DummyDayViewScreen extends ConsumerStatefulWidget {
  const DummyDayViewScreen({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _DummyDayViewScreenState();
}

class _DummyDayViewScreenState extends ConsumerState<DummyDayViewScreen> {
          ...
          Row(
            children: <Widget>[
              ...
              Container(
                  color: const Color(0xFFa278b5),
                  width: cellWidth,
                  child: Text(_viewHeaderText!,
                      textAlign: TextAlign.center,
                      style: const TextStyle(color: Colors.white))),
              Container(
                color: const Color(0xFFa278b5),
                width: cellWidth,
                child: Text(_viewHeaderText1!,
                    textAlign: TextAlign.center,
                    style: const TextStyle(color: Colors.white)),
              ),
              Container(
          ...
          Expanded(
            ...
            onViewChanged: (ViewChangedDetails viewChangedDetails) {
              ...
              if (viewChangedDetails
                ...
                icon5 =
                    const Icon(Icons.wb_iridescent, color: Color(0xff0253e35));
                icon6 = const Icon(
                  Icons.wb_sunny,
                  color: Colors.amber,
                );
